defmodule InstagramWeb.Router do
  ...
  scope "/", InstagramWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{InstagramWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", InstagramWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{InstagramWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", InstagramWeb do
    ...
    live_session :current_user,
      on_mount: [{InstagramWeb.UserAuth, :mount_current_user}] do
